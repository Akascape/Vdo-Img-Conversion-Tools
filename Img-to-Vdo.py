...
switchbtn= Button(root, width=2,bg="#FFFFFF",fg="black", text="⇄",font=("Calibri",12),relief="sunken",cursor='hand2', highlightthickness=0,borderwidth=0,padx=0,pady=0,command=switch)
